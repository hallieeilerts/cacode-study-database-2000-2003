...
countryClass <- read.csv('./data/classification-keys/20201001-CountryModelClass.csv')
################################################################################
...
write.csv(key, paste0("./gen/update-natl-covar-for-old-studies/temp/key_studyid_",ageSexSuffix,".csv",sep =""), row.names = FALSE)
